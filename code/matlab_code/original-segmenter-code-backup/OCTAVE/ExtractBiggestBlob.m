...
imtool close all;  % Close all imtool figures if have img. proc. tlbx.
...
if ~exist(fullFileName, 'file')
	% File doesn't exist -- didn't find it there.  Check the 
    % search path for it.
...
% Get all the areas
allAreas = [blobMeasurements.Area] % No semicolon so it will print to
                                   % the command window.
