...
\section*{TODO:}
\begin{enumerate}
\item plot eccentricity*(area_j/area_initial) vs. time and its time-derivative vs. time
\item plot eccentricity and area and their relative derivatives vs. time
\item write a conclusion
\item write acknowledgements
\item find and cite references?
\end{enumerate}
%\section*{Conclusions}
%
